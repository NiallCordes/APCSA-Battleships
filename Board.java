...
public class Board {
  ...
  // Repeat the same steps with EmptyBoard but now with ViewBoard
  ...
  // Created a printBoard function to print out board to console
  ...
  // Created function to print out the player board to console
  ...
  public void placeShip(Ships ship, int row, int col, boolean orientation, int shipNumber) {
    ...
    // place the rest of the ship using for loop over the length and adding to
  ...
  // function to check if a posiition is correct (not overlapping and in bounds)
  ...
  // check if every ship is sunk, or in other words if the ship list is empty (because every time a ship is sunk, it is removed from the list)
